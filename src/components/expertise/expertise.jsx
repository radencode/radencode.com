    ...
    return (
      <section id='expertise'>
        ...
        <MediaQuery query='(min-width: 1600px)'>
          <Square light={false} size='big' angle='thirty-right' position={{top: '800px', right: '-1000px'}}/>
					<Square light={false} size='big' angle='fifteen-left' position={{top: '400px', left: '-900px'}}/>		
				</MediaQuery>
